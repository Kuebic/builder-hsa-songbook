      ...
      <div className="max-w-2xl mx-auto text-center py-16">
        <Card>
          <CardHeader>
            ...
            <CardTitle className="text-2xl">Songs Library</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                ...
                <li>• Song creation and editing</li>
                <li>• Chord chart display and transposition</li>
                <li>• Arrangement management</li>
