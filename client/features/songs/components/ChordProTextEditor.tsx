...
const CHORD_PRO_DIRECTIVES: AutoCompleteItem[] = [
  ...
  },
  {
    type: "directive",
    text: "{subtitle: }",
    description: "Artist or subtitle",
    insertText: "{subtitle: }",
  },
  {
    type: "directive",
  ...
  },
  {
    type: "directive",
    text: "{c: }",
    description: "Comment (short)",
    insertText: "{c: }",
  },
  {
    type: "section",
    text: "{start_of_chorus}",
    description: "Begin chorus section",
    insertText: "{start_of_chorus}\n\n{end_of_chorus}",
  },
  {
    type: "section",
    text: "{soc}",
    description: "Begin chorus (short)",
    insertText: "{soc}\n\n{eoc}",
  },
  {
    type: "section",
    text: "{start_of_verse}",
    description: "Begin verse section",
    insertText: "{start_of_verse}\n\n{end_of_verse}",
  },
  {
    type: "section",
    text: "{sov}",
    description: "Begin verse (short)",
    insertText: "{sov}\n\n{eov}",
  },
  {
    type: "section",
    text: "{start_of_bridge}",
    description: "Begin bridge section",
    insertText: "{start_of_bridge}\n\n{end_of_bridge}",
  },
  {
    type: "section",
    text: "{sob}",
    description: "Begin bridge (short)",
    insertText: "{sob}\n\n{eob}",
  },
  {
    type: "section",
    text: "{start_of_tab}",
    description: "Begin tab section",
    insertText: "{start_of_tab}\n\n{end_of_tab}",
  },
  {
    type: "section",
    text: "{sot}",
    description: "Begin tab (short)",
    insertText: "{sot}\n\n{eot}",
  },
];
