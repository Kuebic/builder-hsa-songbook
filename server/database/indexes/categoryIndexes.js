...
function getCategoryIndexStats() {
  ...
  stats.forEach((stat) => {
    print(
      `- ${stat.name}: ${stat.accesses.ops} operations since ${stat.accesses.since}`,
    );
  });
...
print("");
print(
  "💡 Pro tip: Monitor index usage with getCategoryIndexStats() to ensure optimal performance",
);
